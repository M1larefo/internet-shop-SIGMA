...
useEffect(() => {
  ...
  setOtherRefCur(OtherRef.current.getBoundingClientRect().top);
        ...
        <p  className={` z-10 cursor-pointer w-10 text-4xl h-2 font-semibold  ${isThemeChanged ? 'text-slate-100' : 'text-gray-800'} relative bottom-[185px] left-[320px]  rounded-xl  ` }>Total:</p>      
                     ...
                     <div  className={` relative  left-[50px] border border-b-gray-400 border-l-transparent border-r-transparent border-t-transparent    font-sans ${productsCounters[key] > 0 ? 'bottom-[280px] ' : 'bottom-[110px]'} font-bold  truncate h-[65px] w-[500px] rounded-xl ${isThemeChanged ? 'text-slate-100' : 'text-gray-800'}  text-4xl text-center pr-[85%] pt-[10px] ` }>{`${charas1}:`} <div className='relative left-[530px] bottom-[40px]'> {`${datas1}`}</div></div>
                     <div  className={` relative   left-[50px] border border-b-gray-400 border-l-transparent border-r-transparent border-t-transparent   font-sans ${productsCounters[key] > 0 ? 'bottom-[280px] ' : 'bottom-[110px]'} font-bold  truncate h-[65px] w-[500px] rounded-xl ${isThemeChanged ? 'text-slate-100' : 'text-gray-800'}  text-4xl text-center pr-[85%] pt-[10px] ` }> {`${charas2}:`} <div className='relative left-[530px] bottom-[40px]'> {`${datas1}`}</div></div>
                     <div  className={` relative   left-[50px] border border-b-gray-400 border-l-transparent border-r-transparent border-t-transparent   font-sans ${productsCounters[key] > 0 ? 'bottom-[280px] ' : 'bottom-[110px]'} font-bold  truncate h-[65px] w-[500px] rounded-xl ${isThemeChanged ? 'text-slate-100' : 'text-gray-800'}  text-4xl text-center pr-[85%] pt-[10px] ` }> {`${charas3}:`} <div className='relative left-[530px] bottom-[40px]'> {`${datas1}`}</div></div>
                     <div  className={` relative   left-[50px]  border border-b-gray-400 border-l-transparent border-r-transparent border-t-transparent  font-sans ${productsCounters[key] > 0 ? 'bottom-[280px] ' : 'bottom-[110px]'} font-bold  truncate h-[65px] w-[500px] rounded-xl ${isThemeChanged ? 'text-slate-100' : 'text-gray-800'}  text-4xl text-center pr-[85%] pt-[10px] ` }> {`${charas4}:`} <div className='relative left-[530px] bottom-[40px]'> {`${datas1}`}</div></div>
                     <div  className={` relative   left-[50px]  border border-b-gray-400 border-l-transparent border-r-transparent border-t-transparent  font-sans ${productsCounters[key] > 0 ? 'bottom-[280px] ' : 'bottom-[110px]'} font-bold  truncate  h-[65px] w-[500px] rounded-xl ${isThemeChanged ? 'text-slate-100' : 'text-gray-800'}  text-4xl text-center pr-[85%] pt-[10px] ` }> {`${charas5}:`} <div className='relative left-[530px] bottom-[40px]'> {`${datas1}`}</div></div>
                     <div  className={` relative   left-[50px] border border-b-gray-400 border-l-transparent border-r-transparent border-t-transparent   font-sans ${productsCounters[key] > 0 ? 'bottom-[280px] ' : 'bottom-[110px]'} font-bold  truncate  h-[65px] w-[500px] rounded-xl ${isThemeChanged ? 'text-slate-100' : 'text-gray-800'}  text-4xl text-center pr-[85%] pt-[10px] ` }> {`${charas6}:`} <div className='relative left-[530px] bottom-[40px]'> {`${datas1}`}</div></div>
                     <div  className={` relative   left-[50px]  border border-b-gray-400 border-l-transparent border-r-transparent border-t-transparent  font-sans ${productsCounters[key] > 0 ? 'bottom-[280px] ' : 'bottom-[110px]'} font-bold  truncate  h-[65px] w-[500px] rounded-xl ${isThemeChanged ? 'text-slate-100' : 'text-gray-800'}  text-4xl text-center pr-[85%] pt-[10px] ` }> {`${charas7}:`}<div className='relative left-[530px] bottom-[40px]'> {`${datas1}`}</div></div>
                     <div  className={` relative   left-[50px] border border-b-gray-400 border-l-transparent border-r-transparent border-t-transparent   font-sans ${productsCounters[key] > 0 ? 'bottom-[280px] ' : 'bottom-[110px]'} font-bold  truncate  h-[65px] w-[500px] rounded-xl ${isThemeChanged ? 'text-slate-100' : 'text-gray-800'}  text-4xl text-center pr-[85%] pt-[10px] ` }> {`${charas8}:`}<div className='relative left-[530px] bottom-[40px]'> {`${datas1}`}</div></div>
                     <div  className={` relative   left-[50px] border border-b-gray-400 border-l-transparent border-r-transparent border-t-transparent   font-sans ${productsCounters[key] > 0 ? 'bottom-[280px] ' : 'bottom-[110px]'} font-bold   truncate h-[65px] w-[500px] rounded-xl ${isThemeChanged ? 'text-slate-100' : 'text-gray-800'}  text-4xl text-center pr-[85%] pt-[10px] ` }> {`${charas9}:`}<div className='relative left-[530px] bottom-[40px]'> {`${datas1}`}</div></div>
                     <div  className={` relative   left-[50px] border border-b-gray-400 border-l-transparent border-r-transparent border-t-transparent   font-sans ${productsCounters[key] > 0 ? 'bottom-[280px] ' : 'bottom-[110px]'} font-bold  truncate  h-[65px] w-[500px] rounded-xl ${isThemeChanged ? 'text-slate-100' : 'text-gray-800'}  text-4xl text-center pr-[85%] pt-[10px] ` }> {`${charas10}:`}<div className='relative left-[530px] bottom-[40px]'> {`${datas1}`}</div></div>
